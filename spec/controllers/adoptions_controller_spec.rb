...
describe Api::V1::AdoptionsController do
  ...
  #         expect { post :create, adoption: params, format: 'json' }.to change { Adoption.count }
  #       end
  ...
  #       it 'se verifica que no se haya creado la adopcion' do
  #         post :create, adoption: params, format: 'json'
  #         new_adoption = Adoption.last
  #         expect(new_adoption).to be_nil
  #       end
  #     end

  #     context 'con un animal sin vacunar o sin castrar' do
  #       before(:each) do
  #         request.headers['X-USER-TOKEN'] = user.authentication_token
  #       end
  ...
  describe 'GET #show' do
    context 'con un usuario con permisos' do 
      ...
      it 'devuelve una array con los datos de la adopcion creada' do
        puts adoption.animal_id
        puts adoption.adopter_id
        puts adoption.date
      end
    end
